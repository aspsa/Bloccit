...
#
# Since we've moved the posts controller under topics and changed the routes, we'll need to modify the class declaration in app/controllers/topics/posts_controller.rb.
#
# Topics::PostsController instructs the controller where to find the appropriate views to invoke. See the Admin::UserPermissions example in the Rails Guide we linked to above.
#
